        ...
        <div class="login-form-container">
            <form id="loginForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="email" id="uEmail" name="uEmail" class="form-control" placeholder="masukkan email"
                        v-model="loginObj.email" />
                </div>

                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="masukkan password" v-model="loginObj.pass" />
                </div>

                <div class="form-group">
                    <input type="submit" value="Masuk sekarang" class="btn">
                    <p>tidak punya akun? <router-link @click="scrollToTop()" to="/register">buat baru!  
                        </router-link>
                    </p>
                </div>
            </form>
