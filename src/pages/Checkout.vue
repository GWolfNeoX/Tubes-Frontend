        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                <div class="checkout-heading">
                    <h3>Sedikit lagi untuk memesan <span>Total</span></h3>
                    <h3 v-if="user">{{ user.user_name }}'s Pesanan<span>${{ calculateSummaryPrice()[3] }}</span></h3>
                </div>
                    ...
                    <div v-if="checkoutObj.paymentMethod == 'card'">
                        ...
                        <div class="form-group">
                            <div class="form-control">
                                <span
                                    style="font-size: 1.6rem; position: absolute; margin-left: -5px; margin-top: -11px;">Tanggal
                                    Kadaluarsa:
                                </span>
                                <input
