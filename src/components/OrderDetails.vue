<template>
    <div class="order-details">
        <div class="order-details-inner">
            <h2 class="d-flex justify-content-between">Pesanan
                <slot></slot>
            </h2>
            ...
            <div class="price">
                <p>Discount: Rp.{{ billMatch.bill_discount }}</p>
                <p>Delivery Fee: Rp.{{ billMatch.bill_delivery }}</p>
                <p>Total: Rp.{{ billMatch.bill_total }}</p>
            </div>
        </div>
    </div>
</template>
